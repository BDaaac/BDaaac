...
![MinIO](https://img.shields.io/badge/MinIO-0d1117?style=for-the-badge&logo=minio&logoColor=C72E49)
...
|---|---|---|
| **Churn Prediction** | CatBoost · SHAP · Pandas | 3-class model on 28M+ rows, cascading architecture — HackNU 2026 finalist |
| **PathoAI** | UNet++ · MAnet · EfficientNet-B4 | Medical biopsy segmentation, val IoU ~0.83 — AI in Healthcare 2026 |
| **QazGeoAI** | CatBoost · RuBERT · ChromaDB | Geospatial investment analysis for Kazakhstan — Decentrathon 5.0 |
